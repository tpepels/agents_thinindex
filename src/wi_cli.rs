...
Related commands:
  build_index        explicit rebuild and diagnostics
  wi-init            write or normalize local agent instructions
  wi-stats           report local wi usage events
  wi-scorecard       report pass/warn/fail value evidence
