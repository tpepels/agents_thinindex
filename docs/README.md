...
| Relationship/navigation docs | [REFERENCE_GRAPH.md](REFERENCE_GRAPH.md), [DEPENDENCY_GRAPH.md](DEPENDENCY_GRAPH.md), [FILE_REFERENCES.md](FILE_REFERENCES.md), [CONTEXT_PACKS.md](CONTEXT_PACKS.md), [IMPACT_ANALYSIS.md](IMPACT_ANALYSIS.md), [FILE_ROLES.md](FILE_ROLES.md) | Describe SQLite-backed refs, dependency and file-reference evidence, context packs, impact output, and file-role mapping. |
...
| Release/distribution docs | [RELEASING.md](RELEASING.md), [INSTALLERS.md](INSTALLERS.md), [NATIVE_DISTRIBUTION_PLAN.md](NATIVE_DISTRIBUTION_PLAN.md), [RELEASE_CHECKLIST.md](RELEASE_CHECKLIST.md), [TARGET_PLATFORM_SMOKE.md](TARGET_PLATFORM_SMOKE.md), [CI_INTEGRATION.md](CI_INTEGRATION.md) | Document local release archives, archive helpers, checksums, target-platform smoke checks, CI gates, and scaffolded future distribution work. |
